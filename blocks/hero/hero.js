export default function decorate(block) {
  ...
  const formPlaceholder = block.querySelector('.hero-input').placeholder;
  const formButtonText = block.querySelector('.hero-button').textContent;
  const backgroundImageUrl = block.style.backgroundImage.slice(5, -2);
